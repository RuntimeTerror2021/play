  ...
  var Es = i((e = {}) => {
    ...
    function Ue(n = 0) {
      ...
      return { id: "cleanup", require: ["pos", "area"], update() {
        ...
        dt2(this.screenArea(), c) ? s = 0 : (s += L(), s >= n && this.destroy());
      } };
    }
    __name(Ue, "Ue");
    i(Ue, "cleanup");
